...
public final class bruce_data_t implements lcm.lcm.LCMEncodable
{
    /**
     * LCM Type: double[3]
     */
    ...
    {
        if (classes.contains(bruce_data.bruce_data_t.class))
            return 0L;
 
        classes.add(bruce_data.bruce_data_t.class);
    ...
    public bruce_data_t(byte[] data) throws IOException
    {
        this(new LCMDataInputStream(data));
    }
 
    public bruce_data_t(DataInput ins) throws IOException
    {
    ...
    public static bruce_data.bruce_data_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        bruce_data.bruce_data_t o = new bruce_data.bruce_data_t();
    ...
    public bruce_data.bruce_data_t copy()
    {
        bruce_data.bruce_data_t outobj = new bruce_data.bruce_data_t();
